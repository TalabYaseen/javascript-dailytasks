let users_array = [
    ...
    html = "<table  border='2'><tr><th>firstName</th><th>age</th><th>email</th><th>height</th><th>weight</th>"
    users_array.forEach(function(user) {
        html+= "<tr><td>" + user.firstName + "</td><td>" + user.age + "</td><td>" + user.email + "</td><td>" + user.height + "</td><td>" + user.weight + "</td></tr>"
    })
    html += "</table"
    document.write(html)
